...
The model consists of two units: the \texit{Question Keywords and Answer Extractor}, which directly selects necessary information about an object from the KG, and the \texit{Natural Language Question Generator}, which is used as an encoder and decoder of the object’s representation. 
